...
# This script runs the management Docker image. Mainly used for install and manual maintenance and is not
# normally needed by the end user unless Sandfly Support needs you to run it.
...
-it sandfly/sandfly-server-mgmt:latest
