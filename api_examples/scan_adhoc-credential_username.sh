...
'],'\
'"ssh_port":22,'\
'"credentials_id":"username_login_example"'\
'},'\
'"credentials":{'\
'"username_login_example":{'\
...
'},'\
'"sandfly_list":['\
'"file_scripts_etc_initd_malicious",'\
'"log_suspicious_username_logged_in_past_24_hours",'\
'"kernel_module_hidden"'\
'],'\
'"tags":['\
'"api_example_tag",'\
'"username_example_tag"'\
']'\
