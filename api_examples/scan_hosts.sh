...
APIPATH="scan"              # API command to call on the Sandfly Server
JQFILTER="."                # Filter for jq in the output section
REQUESTMETHOD="POST"        # HTTP request method for data calls
REQUESTDATA='{'\
'"host_ids":['\
'"Add_The_Host_IDs_To_Be_Scanned_Here...694533a161736def4b8d55080a",'\
'"Add_The_Host_IDs_To_Be_Scanned_Here...2487629282eae533a161736d55"'\
'],'\
'"sandfly_list":['\
